...
load("/Payment Profile Scripts/05 - Support/emv_VISA.js");
...
if(error == "NA:"){
card.close();
throw na + " Offline plaintext PIN validation not supported"
}
card.close();
throw error + " Script Command NOT Applied/ PIN Verification incorrect or PIN blocked for PIN counter reached. Check parameters."
}